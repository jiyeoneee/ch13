...
public class BulletEx extends JFrame{
	public BulletEx() {
		setTitle("사격 게임"); //title 설정
...
class GamePanel extends JPanel {
	...
	class BulletThread extends Thread { //Thread를 받은 BulletThread
